...
|:-------------------------------------------------------------------------|-----------------:|----------------:|-----------------:|-----------------:|-----------------:|----------------:|----------------:|
| Version                                                                  |          13.6.15 |          0.17.4 |           0.15.2 |    0.4.0-alpha.0 |           0.10.1 |          2.1.10 |           0.9.0 |
| Bundle size                                                              |     84,017 bytes |   938,991 bytes |  1,428,575 bytes |  1,583,094 bytes |  1,050,179 bytes | 1,696,176 bytes | 1,701,136 bytes |
| Bundle size (gzipped)                                                    |     25,105 bytes |   284,616 bytes |    532,944 bytes |    592,039 bytes |    397,424 bytes |   591,049 bytes |   594,071 bytes |
